...
urlpatterns = [
    ...
    path('api/', include('userapi.router')),
    path('api/', include('emprendedor.urls')),
    path('api/', include('entrepreneur.urls')),
    path('api/', include('tipo_actividad_economica.urls')),
    path('api/', include('bonos.urls')),
